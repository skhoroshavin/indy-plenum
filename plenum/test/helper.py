...
@contextmanager
def view_change_timeout(tconf, nv_timeout, propose_timeout=None, ic_timeout=None):
    ...
    tconf.NEW_VIEW_TIMEOUT = nv_timeout
    tconf.INITIAL_PROPOSE_VIEW_CHANGE_TIMEOUT = nv_timeout if propose_timeout is None else propose_timeout
